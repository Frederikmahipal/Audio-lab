/**
 * Noise-profile spectral subtraction.
 * Estimate noise from first N frames, then subtract from each frame (with floor).
 */
...
/** Estimate noise spectrum as median magnitude over the first noiseFrames frames. */
...
/** Apply spectral subtraction: subtract alpha * noise from each frame, with floor. */
